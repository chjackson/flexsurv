...
group=Good 
  time     est      lcl      ucl
1    1 8.75794 7.097578 10.78023

group=Medium 
  time      est     lcl      ucl
1    1 4.741585 4.11607 5.448299

group=Poor 
  time      est     lcl      ucl
1    1 2.605819 2.31089 2.931663
\end{Soutput}
\end{Schunk}
...
\item[\code{inits}] A function which provides plausible initial values
  ...
  produce a likelihood of zero, and a fatal error message from the
  optimiser.  SAY IT.
...
Initial values for numerical likelihood maximisation are chosen
using the method described by \citet{royston:parmar}.
